...
-- AddForeignKey
ALTER TABLE `flagpoleattendance` ADD CONSTRAINT `flagpoleattendance_ibfk_3` FOREIGN KEY (`recorderId`) REFERENCES `users`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
-- AddForeignKey
ALTER TABLE `homevisits` ADD CONSTRAINT `fk_homevisits_student` FOREIGN KEY (`studentId`) REFERENCES `students`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

-- AddForeignKey
ALTER TABLE `homevisits` ADD CONSTRAINT `fk_homevisits_teacher` FOREIGN KEY (`teacherId`) REFERENCES `teachers`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

-- AddForeignKey
ALTER TABLE `homevisits` ADD CONSTRAINT `fk_homevisits_updatedby` FOREIGN KEY (`updatedBy`) REFERENCES `users`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
-- AddForeignKey
ALTER TABLE `teachers` ADD CONSTRAINT `teachers_ibfk_1` FOREIGN KEY (`teacherId`) REFERENCES `users`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
