...
const ManageClubsPosts = () => {
    ...
    const filteredClubs = clubsData.filter(club => {
        const matchCategory = selectedCategory === "ทั้งหมด" || club.category === selectedCategory;
        const matchSearch = !query.search.trim() || club.name.toLowerCase().includes(query.search.toLowerCase());
                                            ...
                                            <div className="p-6">
                                                <div className="flex items-start mb-4">
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <div className={`inline-block px-2 py-1 rounded-full text-xs font-medium mt-1 ${club.isActive
                                                ...
                                                {club.registrationDeadline && (
                                                    <div className={`mt-3 text-xs px-2 py-1 rounded ${isOpen ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                                                        }`}>
